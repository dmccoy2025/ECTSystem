...
namespace AF.ECT.Server.Models.Interfaces;
...
public partial interface IALODContextProcedures
{
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_appeal_sp_GetAppealPostCompletionResult>> core_appeal_sp_GetAppealPostCompletionAsync(int? appealId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_APSA_sp_GetPostCompletion stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_APSA_sp_GetPostCompletionResult>> core_APSA_sp_GetPostCompletionAsync(int? appealId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetMailingListForLOD stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetMailingListForLODResult>> core_user_sp_GetMailingListForLODAsync(int? refId, int? groupId, int? status, string? callingService, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetMailingListByUser stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetMailingListByUserResult>> core_user_sp_GetMailingListByUserAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetManagedUsers stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetManagedUsersResult>> core_user_sp_GetManagedUsersAsync(int? userid, string? ssn, string? name, int? status, int? role, int? srchUnit, bool? showAllUsers, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_SearchMamberData stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_SearchMamberDataResult>> core_user_sp_SearchMamberDataAsync(string? ssn, string? firstName, string? lastName, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_SearchMamberData_Test stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_SearchMamberData_TestResult>> core_user_sp_SearchMamberData_TestAsync(string? ssn, string? firstName, string? lastName, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetUserAltTitleResult>> core_user_sp_GetUserAltTitleAsync(int? userId, int? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetUserAltTitleByGroupCompo stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetUserAltTitleByGroupCompoResult>> core_user_sp_GetUserAltTitleByGroupCompoAsync(int? groupId, int? workCompo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetUserName stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetUserNameResult>> core_user_sp_GetUserNameAsync(string? first, string? last, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetUsersAltTitleByGroup stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetUsersAltTitleByGroupResult>> core_user_sp_GetUsersAltTitleByGroupAsync(int? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetUsersOnline stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetUsersOnlineResult>> core_user_sp_GetUsersOnlineAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_GetWhois stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_GetWhoisResult>> core_user_sp_GetWhoisAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_HasHQTechAccount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_HasHQTechAccountResult>> core_user_sp_HasHQTechAccountAsync(int? originUserId, string? userEDIPIN, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_IsFinalStatusCode stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_IsFinalStatusCodeResult>> core_user_sp_IsFinalStatusCodeAsync(byte? statusId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_SearchMemberDataResult>> core_user_sp_SearchMemberDataAsync(int? userId, string? ssn, string? lastName, string? firstName, string? middleName, int? srchUnit, int? rptView, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_user_sp_SearchMemberData_Test stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_SearchMemberData_TestResult>> core_user_sp_SearchMemberData_TestAsync(int? userId, string? ssn, string? name, int? srchUnit, int? rptView, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_user_sp_UpdateLoginResult>> core_user_sp_UpdateLoginAsync(int? userId, string? sessionId, string? remoteAddr, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_AddSignatureResult>> core_workflow_sp_AddSignatureAsync(int? refId, int? moduleType, int? userId, int? actionId, byte? groupId, byte? statusIn, byte? statusOut, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_CopyWorkflowResult>> core_workflow_sp_CopyWorkflowAsync(int? fromId, int? toId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetActionsByStepResult>> core_workflow_sp_GetActionsByStepAsync(int? stepId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetActiveCases stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetActiveCasesResult>> core_workflow_sp_GetActiveCasesAsync(int? refId, short? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetAllFindingByReasonOf stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetAllFindingByReasonOfResult>> core_workflow_sp_GetAllFindingByReasonOfAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetAllLocks stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetAllLocksResult>> core_workflow_sp_GetAllLocksAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetCancelReasons stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetCancelReasonsResult>> core_workflow_sp_GetCancelReasonsAsync(byte? workflowId, bool? isFormal, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetCreatableByGroup stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetCreatableByGroupResult>> core_workflow_sp_GetCreatableByGroupAsync(string? compo, byte? module, byte? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetFindingByReasonOfById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetFindingByReasonOfByIdResult>> core_workflow_sp_GetFindingByReasonOfByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetFindings stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetFindingsResult>> core_workflow_sp_GetFindingsAsync(byte? workflowId, int? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetModuleFromWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetModuleFromWorkflowResult>> core_workflow_sp_GetModuleFromWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetPageAccessByGroup stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetPageAccessByGroupResult>> core_workflow_sp_GetPageAccessByGroupAsync(byte? workflow, int? status, byte? group, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetPageAccessByWorkflowView stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetPageAccessByWorkflowViewResult>> core_workflow_sp_GetPageAccessByWorkflowViewAsync(string? compo, byte? workflow, int? status, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetPagesByWorkflowId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetPagesByWorkflowIdResult>> core_workflow_sp_GetPagesByWorkflowIdAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_Workflow_sp_GetPermissions stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Workflow_sp_GetPermissionsResult>> core_Workflow_sp_GetPermissionsAsync(byte? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_Workflow_sp_GetPermissionsByCompo stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Workflow_sp_GetPermissionsByCompoResult>> core_Workflow_sp_GetPermissionsByCompoAsync(byte? workflowId, string? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetReturnReasons stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetReturnReasonsResult>> core_workflow_sp_GetReturnReasonsAsync(byte? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetRwoaReasons stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetRwoaReasonsResult>> core_workflow_sp_GetRwoaReasonsAsync(byte? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStatusCodesByCompo stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStatusCodesByCompoResult>> core_workflow_sp_GetStatusCodesByCompoAsync(string? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStatusCodesByCompoAndModule stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStatusCodesByCompoAndModuleResult>> core_workflow_sp_GetStatusCodesByCompoAndModuleAsync(string? compo, byte? module, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStatusCodesBySignCode stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStatusCodesBySignCodeResult>> core_workflow_sp_GetStatusCodesBySignCodeAsync(short? groupId, byte? module, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStatusCodesByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStatusCodesByWorkflowResult>> core_workflow_sp_GetStatusCodesByWorkflowAsync(byte? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStatusCodesByWorkflowAndAccessScope stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStatusCodesByWorkflowAndAccessScopeResult>> core_workflow_sp_GetStatusCodesByWorkflowAndAccessScopeAsync(byte? workflowId, byte? accessScope, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStatusCodeScope stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStatusCodeScopeResult>> core_workflow_sp_GetStatusCodeScopeAsync(byte? statusID, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStepsByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStepsByWorkflowResult>> core_workflow_sp_GetStepsByWorkflowAsync(byte? workflow, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetStepsByWorkflowAndStatus stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetStepsByWorkflowAndStatusResult>> core_workflow_sp_GetStepsByWorkflowAndStatusAsync(byte? workflow, byte? status, string? deathStatus, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetViewableByGroup stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetViewableByGroupResult>> core_workflow_sp_GetViewableByGroupAsync(byte? groupId, byte? module, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowByCompo stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowByCompoResult>> core_workflow_sp_GetWorkflowByCompoAsync(string? compo, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowFromModule stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowFromModuleResult>> core_workflow_sp_GetWorkflowFromModuleAsync(int? moduleId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowInitialStatusCode stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowInitialStatusCodeResult>> core_workflow_sp_GetWorkflowInitialStatusCodeAsync(int? compo, int? module, int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowTitle stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowTitleResult>> core_workflow_sp_GetWorkflowTitleAsync(int? moduleId, int? subCase, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowTitleByWorkStatusId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowTitleByWorkStatusIdResult>> core_workflow_sp_GetWorkflowTitleByWorkStatusIdAsync(int? workflowId, int? subCase, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_InsertAction stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_InsertActionResult>> core_workflow_sp_InsertActionAsync(byte? type, short? stepId, int? target, int? data, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_InsertOptionAction stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_InsertOptionActionResult>> core_workflow_sp_InsertOptionActionAsync(byte? type, int? wsoid, int? target, int? data, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowByIdResult>> core_workflow_sp_GetWorkflowByIdAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowsByRefId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowsByRefIdResult>> core_workflow_sp_GetWorkflowsByRefIdAsync(int? refId, byte? module, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowsByRefIdAndType stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowsByRefIdAndTypeResult>> core_workflow_sp_GetWorkflowsByRefIdAndTypeAsync(int? refId, byte? module, int? workflowType, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_workflow_sp_GetWorkflowTypes stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_workflow_sp_GetWorkflowTypesResult>> core_workflow_sp_GetWorkflowTypesAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCasesResult>> core_lod_sp_GetSpecialCasesAsync(CancellationToken? cancellationToken = default);
    ...
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetReinvestigationRequestsResult>> GetReinvestigationRequestsAsync(int? userId, bool? sarc, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_AssociatedCases_GetAssociatedCasesResult>> core_AssociatedCases_GetAssociatedCasesAsync(int? refId, int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_AssociatedCases_GetAssociatedCasesLOD stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_AssociatedCases_GetAssociatedCasesLODResult>> core_AssociatedCases_GetAssociatedCasesLODAsync(int? refId, int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseComments_GetByCase stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseComments_GetByCaseResult>> core_CaseComments_GetByCaseAsync(int? refid, int? module, int? commentType, bool? sorted, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseComments_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseComments_GetByIdResult>> core_CaseComments_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseDialogueComments_GetByCaseResult>> core_CaseDialogueComments_GetByCaseAsync(int? refid, int? module, int? commentType, bool? sorted, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseDialogueComments_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseDialogueComments_GetByIdResult>> core_CaseDialogueComments_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseType_sp_GetAllResult>> core_CaseType_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseType_sp_GetAllSubCaseTypes stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseType_sp_GetAllSubCaseTypesResult>> core_CaseType_sp_GetAllSubCaseTypesAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseType_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseType_sp_GetByIdResult>> core_CaseType_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseType_sp_GetCaseTypeWorkflows stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseType_sp_GetCaseTypeWorkflowsResult>> core_CaseType_sp_GetCaseTypeWorkflowsAsync(int? caseTypeId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseType_sp_GetSubCaseTypes stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseType_sp_GetSubCaseTypesResult>> core_CaseType_sp_GetSubCaseTypesAsync(int? caseTypeId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CaseType_sp_GetWorkflowCaseTypes stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CaseType_sp_GetWorkflowCaseTypesResult>> core_CaseType_sp_GetWorkflowCaseTypesAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CertificationStamp_sp_GetAllResult>> core_CertificationStamp_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CertificationStamp_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CertificationStamp_sp_GetByIdResult>> core_CertificationStamp_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CertificationStamp_sp_GetCerticationStampWorkflows stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CertificationStamp_sp_GetCerticationStampWorkflowsResult>> core_CertificationStamp_sp_GetCerticationStampWorkflowsAsync(int? stampId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CertificationStamp_sp_GetParameterFieldData stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CertificationStamp_sp_GetParameterFieldDataResult>> core_CertificationStamp_sp_GetParameterFieldDataAsync(int? refId, bool? selectSecondary, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CertificationStamp_sp_GetSpecialCaseStamp stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CertificationStamp_sp_GetSpecialCaseStampResult>> core_CertificationStamp_sp_GetSpecialCaseStampAsync(int? refId, bool? selectSecondary, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CertificationStamp_sp_GetWorkflowCertificationStamps stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CertificationStamp_sp_GetWorkflowCertificationStampsResult>> core_CertificationStamp_sp_GetWorkflowCertificationStampsAsync(int? workflowId, bool? isQualified, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ChildCaseComment_GetByCaseResult>> core_ChildCaseComment_GetByCaseAsync(int? refid, int? module, int? commentType, int? commentId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_ChildCaseComment_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ChildCaseComment_GetByIdResult>> core_ChildCaseComment_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CompletedByGroup_sp_GetAllResult>> core_CompletedByGroup_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CompletedByGroup_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CompletedByGroup_sp_GetByIdResult>> core_CompletedByGroup_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CompletedByGroup_sp_GetCompletedByGroupWorkflows stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CompletedByGroup_sp_GetCompletedByGroupWorkflowsResult>> core_CompletedByGroup_sp_GetCompletedByGroupWorkflowsAsync(int? completedByGroupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_CompletedByGroup_sp_GetWorkflowCompletedByGroups stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_CompletedByGroup_sp_GetWorkflowCompletedByGroupsResult>> core_CompletedByGroup_sp_GetWorkflowCompletedByGroupsAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_email_sp_GetAllResult>> core_email_sp_GetAllAsync(string? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_email_sp_GetEmailByID stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_email_sp_GetEmailByIDResult>> core_email_sp_GetEmailByIDAsync(int? templateID, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_email_sp_GetEmailByName stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_email_sp_GetEmailByNameResult>> core_email_sp_GetEmailByNameAsync(string? title, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_GetRoleAbbreResult>> core_GetRoleAbbreAsync(string? groups, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_GetStateAbbre stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_GetStateAbbreResult>> core_GetStateAbbreAsync(string? states, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_DeleteResult>> core_group_sp_DeleteAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetAll stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetAllResult>> core_group_sp_GetAllAsync(int? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetAllWithManaged stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetAllWithManagedResult>> core_group_sp_GetAllWithManagedAsync(short? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetByCompo stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetByCompoResult>> core_group_sp_GetByCompoAsync(string? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetByCompoAndAdmin stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetByCompoAndAdminResult>> core_group_sp_GetByCompoAndAdminAsync(string? compo, byte? adminCurrentGroupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetByCompoOnly stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetByCompoOnlyResult>> core_group_sp_GetByCompoOnlyAsync(string? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetManaged stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetManagedResult>> core_group_sp_GetManagedAsync(short? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetManagedDropDown stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetManagedDropDownResult>> core_group_sp_GetManagedDropDownAsync(short? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_group_sp_GetViewBy stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_GetViewByResult>> core_group_sp_GetViewByAsync(short? groupId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_group_sp_lkupComposResult>> core_group_sp_lkupComposAsync(string? compo, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ICD_sp_Find7thCharactersResult>> core_ICD_sp_Find7thCharactersAsync(int? codeId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_ICD_sp_FindCode stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ICD_sp_FindCodeResult>> core_ICD_sp_FindCodeAsync(string? value, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_ICD_sp_FindCodeVersion stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ICD_sp_FindCodeVersionResult>> core_ICD_sp_FindCodeVersionAsync(int? codeId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_ICD_sp_FindNatureOfIncidentValues stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ICD_sp_FindNatureOfIncidentValuesResult>> core_ICD_sp_FindNatureOfIncidentValuesAsync(int? codeId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_ICD_sp_GetChildren stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_ICD_sp_GetChildrenResult>> core_ICD_sp_GetChildrenAsync(int? parentId, int? version, bool? onlyActive, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetIsReinvestigationLod stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetIsReinvestigationLodResult>> core_lod_sp_GetIsReinvestigationLodAsync(int? lodId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetLODListByMemberSSN stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetLODListByMemberSSNResult>> core_lod_sp_GetLODListByMemberSSNAsync(string? memberSSN, int? searchType, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetLODPostCompletion stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetLODPostCompletionResult>> core_lod_sp_GetLODPostCompletionAsync(int? lodId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetPALDataByMemberSSN stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetPALDataByMemberSSNResult>> core_lod_sp_GetPALDataByMemberSSNAsync(string? member_ssn, string? member_lastname, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetPendingCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetPendingCountResult>> core_lod_sp_GetPendingCountAsync(int? userId, bool? sarc, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetPendingCount_LODV3 stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetPendingCount_LODV3Result>> core_lod_sp_GetPendingCount_LODV3Async(int? userId, bool? sarc, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetPendingIOCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetPendingIOCountResult>> core_lod_sp_GetPendingIOCountAsync(int? userId, bool? sarc, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetPSCDSpecialCaseNotHolding stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetPSCDSpecialCaseNotHoldingResult>> core_lod_sp_GetPSCDSpecialCaseNotHoldingAsync(int? moduleId, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetReinvestigationLodFindings stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetReinvestigationLodFindingsResult>> core_lod_sp_GetReinvestigationLodFindingsAsync(int? initialLodId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetReinvestigationRequestId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetReinvestigationRequestIdResult>> core_lod_sp_GetReinvestigationRequestIdAsync(int? lodId, int? idType, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetReinvestigationRequests stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetReinvestigationRequestsResult>> core_lod_sp_GetReinvestigationRequestsAsync(int? userId, bool? sarc, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetReinvestigationRequestsCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetReinvestigationRequestsCountResult>> core_lod_sp_GetReinvestigationRequestsCountAsync(int? initialLODId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetReinvestigationsCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetReinvestigationsCountResult>> core_lod_sp_GetReinvestigationsCountAsync(int? userId, bool? sarc, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCaseDisposition stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCaseDispositionResult>> core_lod_sp_GetSpecialCaseDispositionAsync(int? moduleId, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCaseHolding stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCaseHoldingResult>> core_lod_sp_GetSpecialCaseHoldingAsync(int? moduleId, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCaseNoDisposition stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCaseNoDispositionResult>> core_lod_sp_GetSpecialCaseNoDispositionAsync(int? moduleId, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCaseNotHolding stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCaseNotHoldingResult>> core_lod_sp_GetSpecialCaseNotHoldingAsync(int? moduleId, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCaseNotHoldingCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCaseNotHoldingCountResult>> core_lod_sp_GetSpecialCaseNotHoldingCountAsync(int? moduleId, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCases stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCasesResult>> core_lod_sp_GetSpecialCasesAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCases_Paging stored procedure with basic paging support.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCases_PagingResult>> core_lod_sp_GetSpecialCases_PagingAsync(int? userId, int? pageNumber, int? pageSize, OutputParameter<int>? totalCount, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCasesByMemberSSNResult>> core_lod_sp_GetSpecialCasesByMemberSSNAsync(string? member_ssn, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCasesByModuleCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCasesByModuleCountResult>> core_lod_sp_GetSpecialCasesByModuleCountAsync(int? userId, int? moduleId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCasesByModuleId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCasesByModuleIdResult>> core_lod_sp_GetSpecialCasesByModuleIdAsync(int? userId, int? moduleId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetSpecialCasesCount stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetSpecialCasesCountResult>> core_lod_sp_GetSpecialCasesCountAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetWorkflowResult>> core_lod_sp_GetWorkflowAsync(int? lODid, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetWSID stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetWSIDResult>> core_lod_sp_GetWSIDAsync(int? iD, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lod_sp_GetWWDListByMemberSSN stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lod_sp_GetWWDListByMemberSSNResult>> core_lod_sp_GetWWDListByMemberSSNAsync(string? memberSSN, int? searchType, int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetChangeSetByLogIdResult>> core_log_sp_GetChangeSetByLogIdAsync(int? logId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_log_sp_GetChangeSetByUserId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetChangeSetByUserIdResult>> core_log_sp_GetChangeSetByUserIdAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_log_sp_GetChangeSetDetails stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetChangeSetDetailsResult>> core_log_sp_GetChangeSetDetailsAsync(string? logIds, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_log_sp_GetChangeSetsByRefId stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetChangeSetsByRefIdResult>> core_log_sp_GetChangeSetsByRefIdAsync(int? refId, byte? module, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_log_sp_GetErrorById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetErrorByIdResult>> core_log_sp_GetErrorByIdAsync(int? iD, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_log_sp_GetErrors stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetErrorsResult>> core_log_sp_GetErrorsAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_log_sp_GetLastChange stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_GetLastChangeResult>> core_log_sp_GetLastChangeAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_log_sp_RecordEmailResult>> core_log_sp_RecordEmailAsync(int? userId, string? eTo, string? eCC, string? eBCC, string? subject, string? body, string? failed, int? templateId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookups_sp_GetMemberComponentsByWorkflowResult>> core_lookups_sp_GetMemberComponentsByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetMemberPSCDCategory stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetMemberPSCDCategoryResult>> core_lookUps_sp_GetMemberPSCDCategoryAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetMemberPSCDStatus stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetMemberPSCDStatusResult>> core_lookUps_sp_GetMemberPSCDStatusAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetPasCodeChainType stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetPasCodeChainTypeResult>> core_lookUps_sp_GetPasCodeChainTypeAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetPEPPCaseTypes stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetPEPPCaseTypesResult>> core_lookUps_sp_GetPEPPCaseTypesAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetPEPPDispositions stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetPEPPDispositionsResult>> core_lookUps_sp_GetPEPPDispositionsAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetPEPPRatings stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetPEPPRatingsResult>> core_lookUps_sp_GetPEPPRatingsAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_GetPEPPTypes stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_GetPEPPTypesResult>> core_lookUps_sp_GetPEPPTypesAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookups_sp_GetRMUById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookups_sp_GetRMUByIdResult>> core_lookups_sp_GetRMUByIdAsync(int? rmuId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookups_sp_GetWorkflowDispositions stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookups_sp_GetWorkflowDispositionsResult>> core_lookups_sp_GetWorkflowDispositionsAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_lookUps_sp_InfoSources stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_lookUps_sp_InfoSourcesResult>> core_lookUps_sp_InfoSourcesAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_memo_sp_GetDataSourcesResult>> core_memo_sp_GetDataSourcesAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_messages_sp_GetAll stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_messages_sp_GetAllMessagesResult>> core_messages_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_messages_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_messages_sp_GetMessagesDetailsResult>> core_messages_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_messages_sp_GetByType stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_messages_sp_GetMessagesResult>> core_messages_sp_GetByTypeAsync(int? type, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_pageTitles_sp_GetAllPagesResult>> core_pageTitles_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_pageTitles_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_pageTitles_sp_GetAllPagesResult>> core_pageTitles_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_pascodes_GetAllUserPasCodesResult>> core_pascode_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_pascode_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_pascode_sp_LoadResult>> core_pascode_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Permission_GetByWorkflowResult>> core_Permission_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_permissions_sp_GetAll stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_permissions_sp_GetAllResult>> core_permissions_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_permissions_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_permissions_sp_GetByUserIdResult>> core_permissions_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_permissions_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Permission_GetByWorkflowResult>> core_permissions_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_role_sp_GetAllResult>> core_role_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_role_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_role_sp_GetByIdResult>> core_role_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_role_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_role_sp_GetAllResult>> core_role_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rule_sp_GetAllResult>> core_rule_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_rule_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rule_sp_GetByIdResult>> core_rule_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_rule_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rule_sp_GetByWorkflowResult>> core_rule_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rules_sp_GetAllResult>> core_rules_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_rules_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rules_sp_GetByIdResult>> core_rules_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_rules_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rules_sp_GetByWorkflowResult>> core_rules_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_rwoa_GetRecentResult>> core_rwoa_GetRecentAsync(int? userId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_sarc_sp_GetAll stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_sarc_sp_GetAllResult>> core_sarc_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_sarc_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_sarc_sp_GetByIdResult>> core_sarc_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_sarc_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_sarc_sp_GetByWorkflowResult>> core_sarc_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_sc_sp_GetRWAssociableSpecialCasesResult>> core_sc_sp_GetRWAssociableSpecialCasesAsync(int? refId, int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_Signature_sp_GetAll stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Signature_sp_GetAllResult>> core_Signature_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_Signature_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Signature_sp_GetByIdResult>> core_Signature_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_Signature_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_Signature_sp_GetByWorkflowResult>> core_Signature_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_SignatureMetaData_sp_GetAllResult>> core_SignatureMetaData_sp_GetAllAsync(OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_SignatureMetaData_sp_GetById stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_SignatureMetaData_sp_GetByIdResult>> core_SignatureMetaData_sp_GetByIdAsync(int? id, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);

    /// <summary>
    /// Asynchronously executes the core_SignatureMetaData_sp_GetByWorkflow stored procedure.
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_SignatureMetaData_sp_GetByWorkflowResult>> core_SignatureMetaData_sp_GetByWorkflowAsync(int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
    ...
    /// </summary>
    Task<List<AF.ECT.Server.Models.ResultTypes.core_sp_GetIRILOAssociableSpecialCasesResult>> core_sp_GetIRILOAssociableSpecialCasesAsync(int? refId, int? workflowId, OutputParameter<int>? returnValue = null, CancellationToken? cancellationToken = default);
