...
public interface IDataService
{
    ...
    Task<List<Models.ResultTypes.core_lod_sp_GetReinvestigationRequestsResult>> GetReinvestigationRequestsAsync(int? userId, bool? sarc, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_lod_sp_GetSpecialCasesResult>> GetSpecialCasesAsync(CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetMailingListForLODResult>> GetMailingListForLODAsync(GetMailingListForLODRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetManagedUsersResult>> GetManagedUsersAsync(GetManagedUsersRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetUserAltTitleResult>> GetUserAltTitleAsync(int? userId, int? groupId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetUserAltTitleByGroupCompoResult>> GetUserAltTitleByGroupCompoAsync(int? groupId, int? workCompo, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetUserNameResult>> GetUserNameAsync(string? first, string? last, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetUsersAltTitleByGroupResult>> GetUsersAltTitleByGroupAsync(int? groupId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetUsersOnlineResult>> GetUsersOnlineAsync(CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_GetWhoisResult>> GetWhoisAsync(int? userId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_HasHQTechAccountResult>> HasHQTechAccountAsync(int? originUserId, string? userEDIPIN, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_IsFinalStatusCodeResult>> IsFinalStatusCodeAsync(byte? statusId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_SearchMemberDataResult>> SearchMemberDataAsync(SearchMemberDataRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_SearchMemberData_TestResult>> SearchMemberDataTestAsync(SearchMemberDataTestRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_user_sp_UpdateLoginResult>> UpdateLoginAsync(int? userId, string? sessionId, string? remoteAddr, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_AddSignatureResult>> AddSignatureAsync(AddSignatureRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_CopyWorkflowResult>> CopyWorkflowAsync(int? fromId, int? toId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetActionsByStepResult>> GetActionsByStepAsync(int? stepId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetActiveCasesResult>> GetActiveCasesAsync(int? refId, short? groupId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetAllFindingByReasonOfResult>> GetAllFindingByReasonOfAsync(CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetAllLocksResult>> GetAllLocksAsync(CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetCancelReasonsResult>> GetCancelReasonsAsync(byte? workflowId, bool? isFormal, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetCreatableByGroupResult>> GetCreatableByGroupAsync(string? compo, byte? module, byte? groupId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetFindingByReasonOfByIdResult>> GetFindingByReasonOfByIdAsync(int? id, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetFindingsResult>> GetFindingsAsync(byte? workflowId, int? groupId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetModuleFromWorkflowResult>> GetModuleFromWorkflowAsync(int? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetPageAccessByGroupResult>> GetPageAccessByGroupAsync(byte? workflow, int? status, byte? group, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetPageAccessByWorkflowViewResult>> GetPageAccessByWorkflowViewAsync(string? compo, byte? workflow, int? status, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetPagesByWorkflowIdResult>> GetPagesByWorkflowIdAsync(int? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_Workflow_sp_GetPermissionsResult>> GetPermissionsAsync(byte? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_Workflow_sp_GetPermissionsByCompoResult>> GetPermissionsByCompoAsync(byte? workflowId, string? compo, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetReturnReasonsResult>> GetReturnReasonsAsync(byte? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetRwoaReasonsResult>> GetRwoaReasonsAsync(byte? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStatusCodesByCompoResult>> GetStatusCodesByCompoAsync(string? compo, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStatusCodesByCompoAndModuleResult>> GetStatusCodesByCompoAndModuleAsync(string? compo, byte? module, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStatusCodesBySignCodeResult>> GetStatusCodesBySignCodeAsync(short? groupId, byte? module, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStatusCodesByWorkflowResult>> GetStatusCodesByWorkflowAsync(byte? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStatusCodesByWorkflowAndAccessScopeResult>> GetStatusCodesByWorkflowAndAccessScopeAsync(byte? workflowId, byte? accessScope, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStatusCodeScopeResult>> GetStatusCodeScopeAsync(byte? statusID, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStepsByWorkflowResult>> GetStepsByWorkflowAsync(byte? workflow, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetStepsByWorkflowAndStatusResult>> GetStepsByWorkflowAndStatusAsync(byte? workflow, byte? status, string? deathStatus, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetViewableByGroupResult>> GetViewableByGroupAsync(byte? groupId, byte? module, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetWorkflowByCompoResult>> GetWorkflowByCompoAsync(string? compo, int? userId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetWorkflowFromModuleResult>> GetWorkflowFromModuleAsync(int? moduleId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetWorkflowInitialStatusCodeResult>> GetWorkflowInitialStatusCodeAsync(int? compo, int? module, int? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetWorkflowTitleResult>> GetWorkflowTitleAsync(int? moduleId, int? subCase, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_GetWorkflowTitleByWorkStatusIdResult>> GetWorkflowTitleByWorkStatusIdAsync(int? workflowId, int? subCase, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_InsertActionResult>> InsertActionAsync(InsertActionRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.core_workflow_sp_InsertOptionActionResult>> InsertOptionActionAsync(InsertOptionActionRequest request, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.ApplicationWarmupProcess_sp_FindProcessLastExecutionDateResult>> FindProcessLastExecutionDateAsync(string? processName, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.ApplicationWarmupProcess_sp_GetAllLogsResult>> GetAllLogsAsync(CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.ApplicationWarmupProcess_sp_IsProcessActiveResult>> IsProcessActiveAsync(string? processName, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workflow_sp_GetWorkflowByIdResult>> GetWorkflowByIdAsync(int? workflowId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workflow_sp_GetWorkflowsByRefIdResult>> GetWorkflowsByRefIdAsync(int? refId, byte? module, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workflow_sp_GetWorkflowsByRefIdAndTypeResult>> GetWorkflowsByRefIdAndTypeAsync(int? refId, byte? module, int? workflowType, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workflow_sp_GetWorkflowTypesResult>> GetWorkflowTypesAsync(CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workstatus_sp_GetWorkstatusByIdResult>> GetWorkstatusByIdAsync(int? workstatusId, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workstatus_sp_GetWorkstatusesByRefIdResult>> GetWorkstatusesByRefIdAsync(int? refId, byte? module, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workstatus_sp_GetWorkstatusesByRefIdAndTypeResult>> GetWorkstatusesByRefIdAndTypeAsync(int? refId, byte? module, int? workstatusType, CancellationToken cancellationToken = default);
    ...
    Task<List<Models.ResultTypes.workstatus_sp_GetWorkstatusTypesResult>> GetWorkstatusTypesAsync(CancellationToken cancellationToken = default);
