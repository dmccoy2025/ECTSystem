...
public class Form348Configuration : IEntityTypeConfiguration<Form348>
{
    ...
    public void Configure(EntityTypeBuilder<Form348> builder)
    {
        ...
        builder.HasIndex(e => e.Status)
            .HasDatabaseName("IX_form348_status");

        builder.HasIndex(e => e.Workflow)
            .HasDatabaseName("IX_form348_workflow");

        builder.HasIndex(e => e.MemberSsn)
            .HasDatabaseName("IX_form348_member_ssn");

        builder.HasIndex(e => e.MemberUnitId)
            .HasDatabaseName("IX_form348_member_unit_id");

        builder.HasIndex(e => e.CreatedDate)
            .HasDatabaseName("IX_form348_created_date");

        builder.HasIndex(e => e.Deleted)
            .HasDatabaseName("IX_form348_deleted");
