...
using AF.ECT.Windows.Options;

namespace AF.ECT.Windows.Services;
...
/// It uses gRPC for desktop compatibility and provides both synchronous
...
public class WorkflowClient : IWorkflowClient
{
    ...
    private void LogAuditEvent(string methodName, string correlationId, DateTime startTime, TimeSpan duration, bool success, string? errorMessage = null, object? additionalData = null)
    {
        var auditEvent = new
        {
            ...
            ClientInfo = new
            {
                UserAgent = "ECTSystem-WinUIClient",
                Version = "1.0.0",
    ...
    /// <summary>
    /// Initializes a new instance of the WorkflowClient with a gRPC client (for testing).
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the WorkflowClient.
    /// </summary>
    ...
    public WorkflowClient(HttpClient httpClient, ILogger<WorkflowClient>? logger = null, IOptions<WorkflowClientOptions>? options = null)
    {
        ...
        // Create gRPC channel for desktop compatibility with optimized settings
